...
export default function SignupForm({ showPhoneVerification, setShowPhoneVerification }: SignupFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <button
        type="submit"
        className="w-full bg-gradient-to-r from-blue-500 to-purple-600 text-white py-3 px-4 rounded-xl hover:from-blue-600 hover:to-purple-700 transition-all duration-200 font-medium mt-6 whitespace-nowrap cursor-pointer"
      >
        회원가입 완료
      </button>
    </form>
